...
if __name__ == '__main__':
	...
	setup(name='python3-dpkgunlocker',
		version='0.1',
		description='Utility to unlock lliurex-up, dpkg or apt.Core library package',
		long_description="""""",
		author='Lliurex Team',
		...
		license='GPL',
		platforms='UNIX',
		packages = ['dpkgunlocker'],
		package_dir = {'dpkgunlocker':'python3-dpkgunlocker'},
		classifiers=[
