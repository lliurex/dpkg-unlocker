...
xgettext --join-existing -kde -ki18nd:2 ./dpkgunlocker-gui/python3-dpkgunlocker-gui/rsrc/ServicesPanel.qml -o ./translations/dpkg-unlocker.pot
...
xgettext --join-existing -kde -ki18nd:2 ./dpkgunlocker-gui/python3-dpkgunlocker-gui/rsrc/ProtectionPanel.qml -o ./translations/dpkg-unlocker.pot
...
xgettext --join-existing -kde -ki18nd:2 ./dpkgunlocker-gui/python3-dpkgunlocker-gui/rsrc/ServicesList.qml -o ./translations/dpkg-unlocker.pot
